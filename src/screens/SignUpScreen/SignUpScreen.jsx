...
import { CommunicationMail } from "../../icons//CommunicationMail";
import Component18 from "../../icons/ComponentLoginBack/ComponentLoginBack";
import { InterfaceCheck } from "../../icons/InterfaceCheck";
import { InterfaceLinkHorizontal } from "../../icons/InterfaceLinkHorizontal";
import { LockLight1 } from "../../icons/LockLight1";
import { UserUser02 } from "../../icons/UserUser02";
      ...
      <div className="sign-up-2">
        <div className="frame">
          <div className="password">
            <UserUser02 className="user-user" />
            <input
              type="text"
        ...
        <img className="alog-logo" alt="Alog logo" src="/img/alog-logo.png" />
      </div>
    </div>
  );
};
